...
const CACHE = 'muehle-v12';
const FILES = ['./', './index.html', './games/muehle.js', './games/vier-gewinnt.js', './games/dame.js', './games/sonde.js', './games/patrouille.js', './manifest.json', './icon-192.png', './icon-512.png', './icon-512-maskable.png'];
