...
- Sci-fi-Bordcomputer-Optik, ruhig, technisch. Farbwelt (nur Palette, keine Figuren/Namen/Logos aus Serien):
  ...
  - Spielauswahl: zwei Kacheln mit SVG-Vorschau in den eigenen Spielfarben, Kachelrahmen in der Akzentfarbe des Spiels.
...
2. Dame als drittes Modul (Olive | Pflaume); Vier gewinnt ist mit Auftrag 3 umgesetzt.
